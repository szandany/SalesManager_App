...
INSERT INTO SALES (ITEM, QUANTITY, AMOUNT) VALUES ('Round coffee chair By Michellotti', 3, 2400.23);
--rollback DELETE FROM SALES WHERE ITEM='Round coffee chair By Michellotti';
